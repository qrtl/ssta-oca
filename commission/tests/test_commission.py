...
class TestCommission(TransactionCase):
    ...
    def test_commission_gross_amount_annual(self):
        self._check_settlements(self.agent_annual, self.commission_section_paid)

    def test_commission_gross_amount_semi(self):
        self.product.list_price = 15100  # for testing specific commission section
        self._check_settlements(self.agent_semi, self.commission_section_invoice)
